...
SCHEMAS = {
    ...
    "get_course_schedule_url": {"name": "get_course_schedule_url", "description": "获取固定课程表网页链接，必须返回 https://k.weisiting.com，可在微信回复中发送给用户。", "parameters": {"type": "object", "properties": {}}},
